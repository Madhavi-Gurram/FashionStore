            ...
            <form action="${pageContext.request.contextPath}/user"
                ...
                <div class="form-group">
                    ...
                    <textarea id="address"
                              ...
                              rows="3">${not empty param.address ? param.address : ''}</textarea>
    ...
    <script>
        ...
        function validateRegisterForm() {
            ...
            if (fullName === '') {
                ...
                showError('fullName', 'nameError', '⚠️ Name must be at least 3 characters.');
                isValid = false;
            }
            ...
            if (phone === '') {
                ...
                showError('phone', 'phoneError', '⚠️ Enter valid 10 digit Indian mobile number.');
                isValid = false;
            }
            ...
            if (address === '') {
                ...
                showError('address', 'addressError', '⚠️ Please enter a complete address.');
                isValid = false;
            }
            ...
            if (password === '') {
                ...
                showError('password', 'passwordError', '⚠️ Password must be at least 6 characters.');
                isValid = false;
            }
            ...
            if (confirmPassword === '') {
                showError('confirmPassword', 'confirmError', '⚠️ Please confirm your password.');
                isValid = false;
            } else if (password !== confirmPassword) {
                showError('confirmPassword', 'confirmError', '⚠️ Passwords do not match!');
                isValid = false;
            }
